...
namespace EFARMING_1.Controllers
{
    ...
    public class FarmersController : ControllerBase
    {
        ...
        public FarmersController(farmerDB context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Farmer>> PostFarmer(Farmer farmer)
        {
          if (_context.Farmers == null)
          {
              return Problem("Entity set 'farmerDB.Farmers'  is null.");
          }
            _context.Farmers.Add(farmer);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetFarmer", new { id = farmer.Fid }, farmer);
        }
        ...
        {
            return (_context.Farmers?.Any(e => e.Fid == id)).GetValueOrDefault();
        }
    }
}
